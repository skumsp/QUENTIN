function [TransNets,TransNetTreesWeight,record,misc,stats] = findTransNetMCMC4(DSamp,nIter,maxdist,nEdgeModif,powers,ndecr,initTree, debugMode,TransNetTrue,aux)
...
MatrToFit = DSamp_dir;
AM_tree = treeAM(tree);
[obj1,treeWeight] = objTransNetPhyloFit2(AM_tree,tree,MatrToFit,aux1);
...
%     MatrToFit = TransNetNew;
    MatrToFit = DSamp_dir;
    [obj1,newtreeWeight] = objTransNetPhyloFit2(AM_newtree,newtree,MatrToFit,aux1);
